...
export default class App extends React.Component {
  ...
  addTodo(newTodo) {
    fetch('/api/todos', {
      ...
      .then(data => {
        ...
        const newData = newTodos.concat(data);
  ...
  toggleCompleted(todoId) {
    const indexOfUpdate = this.state.todos.findIndex(x => x.todoId === todoId);
    const status = this.state.todos[indexOfUpdate].isCompleted;
